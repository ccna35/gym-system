  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:p-0">
        ...
        {/* Modal */}
        <div
          className="relative inline-block w-full max-w-lg p-6 my-8 overflow-hidden text-right align-middle transition-all transform bg-white shadow-xl rounded-2xl"
          dir="rtl"
        >
          {/* Header */}
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div className="space-y-4">
              {/* Membership Select */}
              <div>
                <Label htmlFor="membership_id">{t.payments.membership} *</Label>
                <select
                  id="membership_id"
